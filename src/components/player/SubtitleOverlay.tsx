...
import { getSubtitleTextColor } from './SubtitleTextColorPanel'
...
export function SubtitleOverlay({ subtitles, deviceType }: SubtitleOverlayProps) {
  ...
  return (
    ...
    >
      <div
        className="NAME-subtitle-text px-2 py-1 text-center rounded max-w-[90%] md:max-w-[70%] lg:max-w-[60%] will-change-transform pointer-events-auto cursor-grab active:cursor-grabbing select-none"
        style={{
