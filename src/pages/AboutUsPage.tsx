  ...
  return (
    <main className="px-4 mt-6 pb-8 max-w-4xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid desktop:grid-cols-2 gap-4">
          <div className="flex flex-col gap-3 p-5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
              ...
              giúp bạn xem video YouTube kèm file phụ đề <span className="text-(--main-cl) font-medium">.srt</span> tự
              upload, đồng thời tích hợp AI để <span className="text-(--main-cl) font-medium">dịch tự động</span> phụ đề
              sang tiếng Việt.
            </p>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
          ...
          <div className="flex flex-col gap-3 p-5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Rất nhiều video giáo dục, bài giảng, và nội dung hay trên YouTube không có phụ đề tiếng Việt. ytosub ra
              đời để giải quyết đúng cái gap đó — cho phép bất kỳ ai xem hiểu nội dung video{' '}
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid sm:grid-cols-2 desktop:grid-cols-3 gap-3">
          {FEATURES.map(f => (
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col desktop:flex-row gap-0 overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
          {(
            [
              {
                step: '1',
            ...
            <div
              key={s.step}
              className="relative flex-1 flex flex-col gap-3 p-5 border-b desktop:border-b-0 desktop:border-r border-zinc-200 dark:border-zinc-800 last:border-0"
            >
              ...
              {i < arr.length - 1 && (
                <div className="hidden desktop:flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-10 w-5 h-5 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 items-center justify-center">
                  <svg
                    width="10"
                    height="10"
                    viewBox="0 0 24 24"
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col desktop:flex-row items-center desktop:items-start gap-5 p-6 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
          <div
            className="w-16 h-16 rounded-full flex items-center justify-center shrink-0 border-2 border-(--main-cl)/60"
            style={{
              background: 'radial-gradient(circle at 40% 35%, color-mix(in srgb, var(--main-cl) 20%, #18181b), #18181b)'
            }}
          >
            <svg
              width="30"
          ...
          <div className="flex flex-col gap-2 text-center desktop:text-left">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-sm">
              Xây dựng các công cụ web thiết thực, tập trung vào trải nghiệm mượt mà và hiệu năng cao. ytosub là dự án
              cá nhân sinh ra từ nhu cầu thực tế khi xem video nước ngoài mỗi ngày.
            </p>

            <div className="flex gap-3 justify-center desktop:justify-start mt-1">
              <a
